 ...
 * 3、sqlSession和connection一样他都是非线程安全。每次使用都应该去获取新的对象。
...
public class MybatisTest {
    ...
    public void testInnerParam() throws IOException {
        ...
        try {
            ...
            List<Employee> list = employeeMapperDynamicSQL.getEmpsTestInnerParameter(employee);
